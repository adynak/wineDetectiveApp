...
class ProducerViewController :UITableViewController {
    ...
    let refreshControlP: UIRefreshControl = {
    ...
    override func viewDidLoad() {
        ...
        refreshControlP.addTarget(self, action: #selector(reloadSourceData(_:)), for: .valueChanged)

    }
                    
    func setupNavBar(){
        navigationController?.navigationBar.prefersLargeTitles = false
        navigationItem.title = NSLocalizedString("titleProducer", comment: "navagation title: producer")
