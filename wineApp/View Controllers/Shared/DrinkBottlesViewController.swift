...
class DrinkBottlesViewController: UIViewController , WKNavigationDelegate{
    ...
    override func viewDidLoad() {
        ...
        navigationItem.title = NSLocalizedString("removeBottles", comment: "")
...
//        let aURLString = "https://www.cellartracker.com/barcode.asp?iWine=3395923"
...
//        webView.frame = CGRect(x: 0, y: 25, width: 414, height: 786)
    ...
    func webView(_ webView: WKWebView, didStartProvisionalNavigation navigation: WKNavigation!) {
        let localizedText = NSLocalizedString("loadingWebPage", comment: "")
